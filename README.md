...
| 2007 | **[S60 3rd Edition FP1 — Nokia N95](docs/placards.md#s60-3rd-edition-fp1--nokia-n95)** | Nokia / Symbian | [`symbian.html`](symbian.html) | The best-specified phone on Earth in March 2007, and the argument that it did not matter: it won every line of the spec sheet but one — and that one, a touchscreen you could read the web on, was the whole game. Softkeys, a five-way navigator, real T9, real multitasking, then a WebKit browser you must read with a keypad |
...
| 2008 | **[Windows Mobile 6.1 Professional — HTC Touch Pro](docs/placards.md#windows-mobile-61-professional--htc-touch-pro)** | Microsoft / HTC | [`winmobile.html`](winmobile.html) | Windows in your pocket was the wrong idea, executed competently, for a decade: a real computer that multitasked, browsed its own filesystem, edited Office documents and did Exchange push with remote wipe — and had to be touched with a stick. Switch to Finger mode and miss a checkbox; press X on four programs and find all four still running; then fall through HTC’s lovely TouchFLO 3D into a 2003 stylus dialog |
| 2008 | **[iPhone OS 2.0 and the App Store](docs/placards.md#iphone-os-20-and-the-app-store--iphone-3g)** | Apple | [`iphoneos2.html`](iphoneos2.html) | The correction that became the business model: an activation that fails four times because it did, a new icon on the home screen, and a grey square filling from left to right — plus 187 invented applications, a $999.99 gem that is pulled after a day, and a chart that pulls every price to $0.99 |
...
| 2011 | **[Android 4.0 — Galaxy Nexus](docs/placards.md#android-40--galaxy-nexus)** | Google / Samsung | [`android4.html`](android4.html) | The release that made the winner look like it deserved to win: Holo built first as a real layer, three buttons drawn on the screen and none on the glass, a Recents card stack you swipe clear — and a skin toggle and a version dashboard that show how few people ever saw it |
| 2011 | **[Windows Phone 7.5 “Mango” — Nokia Lumia 800](docs/placards.md#windows-phone-75-mango--nokia-lumia-800)** | Microsoft / Nokia | [`winphone7.html`](winphone7.html) | The interface that won the design argument and lost the market: typography as the whole interface, a Start screen two tiles wide with an empty gutter down its right, and eight named transitions with nothing anywhere that fades — tap a tile and the others fly off to the right, tap a name and watch the name itself become the next page’s title. On a polycarbonate body that was the Nokia N9’s, carrying Nokia’s two competing futures in the same year |
